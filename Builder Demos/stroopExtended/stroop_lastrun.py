...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.50.04), June 21, 2011, at 18:16
...
#User-defined variables = ['feedback', 'feedback_2', 'instr1', 'instrText', 'instruct', 'instructPractice', u'message', 'practice', 'ready', 'ready1', 'resp', 'thanks', 'thanksText', 'trial', 'trials', 'word']
...
practice=data.TrialHandler(nReps=1.0, method='random', 
    extraInfo=expInfo, originPath='C:\\Documents and Settings\\lpxrs\\My Documents\\Code\\Experiments\\Builder Demos\\stroopExtended\\stroop.psyexp',
...
msg=''
feedback_2=visual.TextStim(win=win, ori=0,
    text=msg,
    font='Arial',
    pos=[0, 0], height=0.1,
...
#run the trial
continueInstructpractice=True
t=0; instructPracticeClock.reset()
while continueInstructpractice and (t<1000000.0000):
    #get current time
    ...
    if (0.0 <= t):
        ...
        if len(theseKeys)>0:#at least one key was pressed
            ...
            continueInstructpractice=False
