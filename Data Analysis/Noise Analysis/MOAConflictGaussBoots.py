...
LMSalmonBackground = pylab.axvspan(-0.1, 0.05, facecolor = 'mediumaquamarine', alpha = 0.25)
LMGreenBackground = pylab.axvspan(0.05, 0.15, facecolor = 'lightcoral', alpha = 0.25)
LumBlkBackground = pylab.axvspan(-0.1, 0.0, facecolor = 'gray', alpha = 0.5)
LumWhiteBackground = pylab.axvspan(0.0, 0.15, facecolor = 'white', alpha = 0.25)
...
SPurpleBackground = pylab.axvspan(-0.1, 0.05, facecolor = 'mediumpurple', alpha = 0.25)
SLimeBackground = pylab.axvspan(0.05, 0.15, facecolor = 'yellowgreen', alpha = 0.25)
LumBlkBackground = pylab.axvspan(-0.1, 0.0, facecolor = 'gray', alpha = 0.5)
LumWhiteBackground = pylab.axvspan(0.0, 0.15, facecolor = 'white', alpha = 0.25)
...
LMSalmonBackground = pylab.axvspan(-0.1, 0.0, facecolor = 'mediumaquamarine', alpha = 0.25)
LMGreenBackground = pylab.axvspan(0.0, 0.15, facecolor = 'lightcoral', alpha = 0.25)
SPurpleBackground = pylab.axvspan(-0.1, 0.05, facecolor = 'mediumpurple', alpha = 0.25)
SLimeBackground = pylab.axvspan(0.05, 0.15, facecolor = 'yellowgreen', alpha = 0.25)
