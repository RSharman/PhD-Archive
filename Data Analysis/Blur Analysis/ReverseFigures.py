...
lone = pylab.bar(xLoneLocations, loneMeans, facecolor = '#0032ff', alpha = 0.2, edgecolor = 'Black', width = xwidth, bottom =0, yerr=loneStandardErrors, ecolor = 'Black')

combo = pylab.bar(xComboLocations, comboMeans, facecolor = '#0132fa', alpha = 0.82, width = xwidth, bottom =0, yerr=comboStandardErrors, ecolor = 'Black')
pylab.xlim([0, 3.5])
