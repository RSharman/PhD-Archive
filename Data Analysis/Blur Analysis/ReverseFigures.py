...
#achromSE = 0.116250102688
#isolumSE = 0.625416974806
#comboStandardErrors = [0.12711785624, 1.43284851131]
#lumSE = 0.12711785624
#chromSE = 1.43284851131
...
fig = pylab.figure(1, figsize=(8.5,6))
...
#achromBar = pylab.bar(xAchromLocation, achromMean, facecolor = '#0032ff', alpha = 0.2,edgecolor = 'Black', width = xwidth, bottom =0, label = 'Alone')
#achromBar2 = pylab.bar(xAchromLocation, achromMean, facecolor = 'none', alpha = 1.0,edgecolor = 'Black', width = xwidth, bottom =0, yerr=achromSE, ecolor = 'Black')
achromBar = pylab.bar(xAchromLocation, achromMean, facecolor = 'gainsboro', alpha = 1.0,edgecolor = 'Black', width = xwidth, bottom =0, yerr=achromSE, ecolor = 'Black', label = 'Alone')
#isolumBar = pylab.bar(xIsolumLocation, isolumMean, facecolor = '#0032ff', alpha = 0.2, edgecolor = 'Black', width = xwidth, bottom =0)
#isolumBar2 = pylab.bar(xIsolumLocation, isolumMean, facecolor = 'none', alpha = 1.0, edgecolor = 'Black', width = xwidth, bottom =0, yerr=isolumSE, ecolor = 'Black')
isolumBar = pylab.bar(xIsolumLocation, isolumMean, facecolor = 'gainsboro', alpha = 1.0, edgecolor = 'Black', width = xwidth, bottom =0, yerr=isolumSE, ecolor = 'Black', hatch = '/')

#lumBar = pylab.bar(xLumLocation, lumMean, facecolor = '#0032ff', alpha = 0.8, edgecolor = 'Black', width = xwidth, bottom =0, label = 'Combined')
#lumBar = pylab.bar(xLumLocation, lumMean, facecolor = 'none', alpha = 1.0, edgecolor = 'Black', width = xwidth, bottom =0, yerr=lumSE, ecolor = 'Black', hatch = '/')
lumBar = pylab.bar(xLumLocation, lumMean, facecolor = 'gray', alpha = 1.0, edgecolor = 'Black', width = xwidth, bottom =0, yerr=lumSE, ecolor = 'Black', label = 'Combined')#hatch = '/')
#chromBar = pylab.bar(xChromLocation, chromMean, facecolor = '#0032ff', alpha = 0.8, edgecolor = 'Black', width = xwidth, bottom =0)
#chromBar = pylab.bar(xChromLocation, chromMean, facecolor = 'none', alpha = 1.0, edgecolor = 'Black', width = xwidth, bottom =0, yerr=chromSE, ecolor = 'Black', hatch = '/')
chromBar = pylab.bar(xChromLocation, chromMean, facecolor = 'gray', alpha = 1.0, edgecolor = 'Black', width = xwidth, bottom =0, yerr=chromSE, ecolor = 'Black', hatch = '/')

pylab.xlim([0, 3.5])
pylab.xticks(ticks, labels)
pylab.yticks(yticks, yticks)
pylab.xlabel('Conditions', fontsize = fontsize, fontname = fontName)
pylab.ylabel('Blur Discrimination Threshold (Degrees)', fontsize = fontsize, fontname = fontName)
...
pylab.setp(ltext, fontsize=fontsize, fontname=fontName)

#pylab.ax3(im, use_gridspec=True)
