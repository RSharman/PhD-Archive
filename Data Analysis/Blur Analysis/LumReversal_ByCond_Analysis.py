...
#    
    for imageName, array in thisIndDat.extraInfo['images'].iteritems():
...
#        pylab.xlim([-1, 2.5])
        ...
        picture = thisIndDat.extraInfo['images'].keys()
        picture = picture[0]
        
        print 'last 6 reversals mean for %s, %s = %.3f' %(observer, picture, (scipy.average(thisIndDat.reversalIntensities[-6:])))
