...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.64.00), May 31, 2011, at 11:43
...
#User-defined variables = [u'Gabor', 'Instructions', 'Intro', 'key_resp', u'key_resp_2', 'trial', u'trials']
known_name_collisions = None  #(collisions are bad)

#store info about the experiment
expName='StairTest1'#from the Builder filename that created this script
    ...
    while continueTrial and (t<1000000.0000):
        ...
        if (0.0 <= t):
            ...
            if len(theseKeys)>0:#at least one key was pressed
                ...
                #was this 'correct'?
                if (key_resp_2.keys==str(u'')): key_resp_2.corr=1
