...
#Save Data
if not os.path.isdir('ConflictMOA_%s' %info['participant']):
    os.mkdir('ConflictMOA_%s' %info['participant'])
if info['Flip']=='n':
    if info['Choose']=='none':
        fileName = 'ConflictMOA_%s//ConflictMOALong_Gap%.2f_EContrLM%.2f_EContrS%.2f_EContrS%.2f_%s_%s' %(info['participant'], info['Gap'],\
                    info['Edge Contrast LM'], info['Edge Contrast S'], info['Edge Contrast Lum'], info['dateStr'], info['participant']) 
    if info['Choose']!='none':
        fileName = 'ConflictMOA_%s//ConflictMOALong_Choose%s_Gap%.2f_EContrLM%.2f_EContrS%.2f_EContrS%.2f_%s_%s' %(info['participant'], info['Choose'], info['Gap'],\
                    info['Edge Contrast LM'], info['Edge Contrast S'], info['Edge Contrast Lum'], info['dateStr'], info['participant'])
if info['Flip']=='y':
    if info['Choose']=='none':
        fileName = 'ConflictMOA_%s//ConflictMOALong_Flipped_Gap%.2f_EContrLM%.2f_EContrS%.2f_EContrS%.2f_%s_%s' %(info['participant'], info['Gap'],\
                    info['Edge Contrast LM'], info['Edge Contrast S'], info['Edge Contrast Lum'], info['dateStr'], info['participant']) 
    if info['Choose']!='none':
        fileName = 'ConflictMOA_%s//ConflictMOALong_Flipped_Choose%s_Gap%.2f_EContrLM%.2f_EContrS%.2f_EContrS%.2f_%s_%s' %(info['participant'], info['Choose'], info['Gap'],\
                    info['Edge Contrast LM'], info['Edge Contrast S'], info['Edge Contrast Lum'], info['dateStr'], info['participant'])
