...
for thisStair in stairs:
    fName = 'ColorNulling_%s//ColorNulling_%s_%s_%s' %(thisStair.extraInfo['participant'], thisStair.extraInfo['participant'], thisStair.extraInfo['condition'], info['dateStr'])
