...
#these work OK
lum = makeEdgeGauss(width=blur,center=0.5)*0.3
...
noise1 = makeFilteredNoise(512, radius=0.05)*0.1
lum = lum+noise1
noise2 = makeFilteredNoise(res=512, radius=0.05)*0.5
lm += noise2
...
noise3 = visual.PatchStim(myWin, tex = noise1, size = 10.0, units = 'deg', sf=(1/10.0))
noise4 = visual.PatchStim(myWin, tex = noise2, size = 10.0, units = 'deg', sf=(1/10.0))
